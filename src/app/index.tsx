...
type Sheet = { type: 'day'; date: string; presetWork: boolean } | { type: 'allowance'; id: string | null; date: string } | { type: 'jobs' } | { type: 'backup' } | null;
...
export default function HomeScreen() {
  ...
  return <SafeAreaView edges={['top']} style={styles.safe}>
    <ScrollView contentContainerStyle={[styles.content, { paddingBottom: 112 + insets.bottom }]} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
      <View style={styles.top}><Text style={styles.title}>Stundenbuch</Text><RoundButton icon="download-outline" label="Daten sichern" onPress={() => setSheet({ type: 'backup' })} /></View>
